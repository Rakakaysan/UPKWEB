                ...
                <div class="card-body">
                    <form action="{{ route('materi.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="4" class="form-control" placeholder="Masukkan deskripsi materi..." required></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="tautan_video" class="form-label">Tautan Video</label>
                            <input type="url" name="tautan_video" id="tautan_video" class="form-control" placeholder="https://youtube.com/..." required>
                        </div>
